...
export const recipes: RecipeData[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Deglaze with white wine, scraping up browned bits. Add beef broth, bay leaf, and thyme. Simmer for 30 minutes.",
      "Preheat broiler. Ladle soup into oven-safe bowls. Top each with a slice of baguette and a generous amount of both cheeses.",
      "Broil until cheese is bubbly and golden brown. Serve immediately."
    ],
    text_blob: "Classic French soup with caramelized onions, beef broth, and a cheesy crouton topping",
    imageUrl: "https://www.jocooks.com/wp-content/uploads/2022/11/french-onion-soup-1-21.jpg",
    macros: {
      calories: 380,
      protein_g: 18,
      carbs_g: 32,
